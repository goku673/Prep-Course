...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  var total  = 1 ; 
  for(let i = 0 ; i <arguments.length; i++) total = total *arguments[i];
  return total ; 
}
...
function breakStatement(numero) {
  //I  //Guardar cada nuevo valor en un array. 
  //Devolver el array
  //Si en algún momento el valor de la suma y la cantidad de iteraciones coinciden, debe interrumpirse la ejecución y 
  //devolver: "Se interrumpió la ejecución"
  //Pista: usá el statement 'break'
  // Tu código:terar en un bucle aumentando en 2 el numero recibido hasta un límite de 10 veces.
  var  numerillo  = [];
  var suma = numero;
  for(var i = 0 ;  i < 10 ; i++){
     ...
     suma = suma+2 ; 
     if (suma===i)break ; 
     else numerillo.push(suma);
  }

  if (i<10) return "Se interrumpió la ejecución";
  else return numerillo ; 
